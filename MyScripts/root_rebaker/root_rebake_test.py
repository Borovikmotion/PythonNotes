...
rebake1 = ObjectRebaker(path = "D:/Scripts/03/testVault", objName = "root", childObjName = "pelvis", offsetPosX = 0, offsetPosY = 0, offsetPosZ = 0, offsetRotX = 0, offsetRotY = 0, offsetRotZ = 0, moveChilds = False)
