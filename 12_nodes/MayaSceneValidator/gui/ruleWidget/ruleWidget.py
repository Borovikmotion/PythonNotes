...
class RuleWidget(QtWidgets.QWidget):
    ...
    def __init__(self, rule_name="test", rule_description="test", rule_instance=None):
    ...
    def on_rule_run(self):
        ...
        self.signal_validator_run.emit(rule_name)

    def on_rule_fix(self):
        rule_name = self.rule_name
        self.signal_validator_fix.emit(rule_name)
